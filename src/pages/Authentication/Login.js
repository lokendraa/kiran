...
async doLogin(values){
   ...
   //   history.push("/dashboard")
    ...
    constructor(props) {
        ...
        this.state = {  username : "admin", password : "12345" }
                                    ...
                                    <Col lg={9}>
                                        <div>
                                            <div className="text-center">
                                                <div>
                                                    <Link to="/" className="logo"><h3>Trading</h3></Link>
                                                </div>
    
                                                <h4 className="font-size-18 mt-4">Welcome Back !</h4>
                                                <p className="text-muted">Sign in to continue to Trading.</p>
                                            </div>
                                            ...
                                            <div className="mt-5 text-center">
                                                ...
                                                <p>© 2021 ONYXTRADE by ThinkZyTech.</p>
                                            </div>
                                        </div>
